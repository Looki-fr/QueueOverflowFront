...
const YourQuestionsList = (props) => {
    ...
    useEffect(() => {
        ...
        props.setLastPage(description ? `/yourQuestions?search=${description}` : "/yourQuestions");
...
export default YourQuestionsList;